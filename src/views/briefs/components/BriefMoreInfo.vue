<template>
  <div>
    ...
    <div class="max-width-sm">
      ...
      <p class="text-sm"><strong>MAYBE use other applications for images and graphics.</strong> The style tile must be completed in our design tool. That said, some brand assets may be provided in other file formats (e.g., .jpg, .png, .svg). It’s ok to use other applications to create and manipulate graphics and images; just upload those assets in WordPress as seen in the intoduction video.</p>
      ...
      <p class="text-sm"><strong>MAYBE explore more than one style tile.</strong> You are welcome to submit more than one concept. Just ask us for a new design tool URL. Of course, in the end, we will choose only one of your directions to move forward with.</p>
    </div>
