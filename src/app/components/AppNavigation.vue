<template>
  <header class="f-header position-relative">
    ...
    <div class="f-header__nav" role="navigation">
      <div class="f-header__nav-grid container">
        ...
        <ul class="f-header__list margin-right-md">
          ...
          <li class="f-header__item">
            <router-link 
              :to="{ name: 'assetsIntake', params: { organization: authStore.organization }}" 
              class="f-header__link"
            >
              Intake
            </router-link>
          ...
          <li class="f-header__item">
            <router-link 
              :to="{ name: 'styleTileBrief', params: { organization: authStore.organization }}" 
              class="f-header__link"
            >
              Brief
            </router-link>
          ...
          <li class="f-header__item">
            <router-link 
              :to="{ name: 'sites', params: { organization: authStore.organization}}" 
              class="f-header__link"
            >
              Sites
            </router-link>
          ...
          <li class="f-header__item">
            <router-link 
              :to="{ name: 'content', params: { organization: authStore.organization, site: 1 }}" 
              class="f-header__link"
            >
              Content
            </router-link>
